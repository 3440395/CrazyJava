...
import static com.xk.sample.net.mindview.util.Print.*;
...
public class Stacks {
  public static void main(String[] args) {
    ...
    com.xk.sample.net.mindview.util.Stack<String> stack2 =
      new com.xk.sample.net.mindview.util.Stack<String>();
    for(Month m : Month.values())
